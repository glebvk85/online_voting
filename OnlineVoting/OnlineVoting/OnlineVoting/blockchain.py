...
class DataBaseSystem:
    ...
    def add_voting(self):
        ...
        for i in temp:
            ...
            if voting is None:
                contract = Vote(member.id, member.username, lecture.id)
                contract.timestamp = int(time.mktime(date.datetime.strptime('09-11-2017 07:42:00', '%d-%m-%Y %H:%M:%S').timetuple()))
                appendTransaction(contract)
                self.transactions.append(contract)

    def add_publication(self):
        temp = [
                    ('59f9539795bf402b0d745ded', '12.12.2017 16:00:00',
                    [('12.12.2017 17:00:00',	'58e4e28b768539fe28c0db69',	10	,10	,10	,10	,10),
                    ('12.12.2017 17:00:00',	'56166acbe42b8784b493f499',	8	,9	,6	,6	,10),
                    ('12.12.2017 17:00:00',	'58eb69cd4705fa27d8688752',	9	,9	,7	,8	,10),
                    ('12.12.2017 17:00:00',	'5950f9d05e029db06d708dd1',	8	,8	,9	,8	,9 ),
                    ('12.12.2017 17:00:00',	'5926f843cfd6a8a4380b0975',	8	,8	,10	,9	,10),
                    ('12.12.2017 17:00:00',	'55e91e3e95a44b9d0645cf31',	9	,8	,6	,7	,9 ),
                    ('12.12.2017 17:00:00',	'543b7148b9bb86843b4b9955',	9	,10	,8	,8	,8 ),
                    ('12.12.2017 17:00:00',	'595492dc6a00fd4a576b432d',	10	,10	,9	,9	,10),
                    ('12.12.2017 17:00:00',	'56166b31aad8642b07fc4035',	7	,7	,10	,9	,9 )]),

                    ('59f9517d13a22153205b6c86', '14.12.2017 16:00:00',
                    [('14.12.2017 17:05:34','5926f843cfd6a8a4380b0975',8	,9	,9	,8	,10),
                    ('14.12.2017 17:08:46',	'543b7148b9bb86843b4b9955',8	,10	,6	,4	,8 ),
                    ('14.12.2017 17:18:55',	'56166b31aad8642b07fc4035',6	,5	,7	,7	,6 ),
                    ('14.12.2017 18:46:47',	'595492dc6a00fd4a576b432d',7	,6	,8	,7	,8 ),
                    ('14.12.2017 19:24:58',	'56166acbe42b8784b493f499',6	,6	,7	,6	,9 ),
                    ('14.12.2017 23:32:02',	'5950f9d05e029db06d708dd1',9	,9	,7	,9	,9 ),
                    ('14.12.2017 23:50:03',	'58eb69cd4705fa27d8688752',8	,8	,9	,8	,10),
                    ('15.12.2017 9:52:39', '580ee2cc503dabc477f48b30',7,	8	,9	,8	,10 ),
                    ('17.01.2018 9:03:04', '5926f843cfd6a8a4380b0975',10	,10	,10	,10	,10),
                    ('17.01.2018 9:06:02', '563dfbf76c439c6464b295a8',10	,10	,10	,8	,10)]),

                    ('59f993a9efe2c178dfecb947', '26.12.2017 16:00:00',
                    [('26.12.2017 16:31:45',	'5950f9d05e029db06d708dd1',	7	,7	,9	,8	,8  ),
                    ('26.12.2017 16:31:49',	'56d6ba21c234a7edf72880cc',	6	,7	,10	,7	,8  ),
                    ('26.12.2017 16:33:38',	'58e4e28b768539fe28c0db69',	7	,7	,9	,9	,9  ),
                    ('26.12.2017 16:42:59',	'583ebed850e2f6dda2f0740e',	10	,10	,10	,10	,10 ),
                    ('26.12.2017 20:31:01',	'580ee2cc503dabc477f48b30',	6	,6	,8	,8	,10 ),
                    ('26.12.2017 21:00:48',	'547c4ea5bab38bfebcc6a241',	8	,5	,6	,7	,7  ),
                    ('26.12.2017 21:58:53',	'595492dc6a00fd4a576b432d',	7	,7	,8	,8	,8  ),
                    ('27.12.2017 7:30:12',	'543b7148b9bb86843b4b9955',	8	,9	,9	,9	,9  ),
                    ('27.12.2017 9:17:25',   '56166b31aad8642b07fc4035',	7	,7	,9	,9	,9  )]),

                    ('5a014cd62ef34efb97f3ec63', '25.01.2018 16:00:00',
                    [('25.01.2018 16:50:18',	'56166acbe42b8784b493f499',	9	,8	,7	,7	,10   ),
                    ('25.01.2018 16:51:57',	'55e91e3e95a44b9d0645cf31',	10	,9	,6	,5	,10   ),
                    ('25.01.2018 17:18:38',	'58a42d8be7ccede2272d51d1',	8	,3	,6	,6	,7    ),
                    ('25.01.2018 17:50:52',	'595492dc6a00fd4a576b432d',	9	,8	,9	,9	,10   ),
                    ('25.01.2018 17:55:29',	'59568011a4432b4bd9e96a23',	10	,8	,6	,5	,5    ),
                    ('25.01.2018 18:18:59',	'58cf6bbdb5ad126ff7c90493',	8	,8	,9	,10	,10   ),
                    ('25.01.2018 19:32:26',	'5926f843cfd6a8a4380b0975',	10	,10	,9	,10	,10   ),
                    ('26.01.2018 8:11:21',   '58eb69cd4705fa27d8688752',	9	,9	,8	,8	,10   ),
                    ('26.01.2018 9:21:39',   '59f99b5440501362b9cdb354',	8	,7	,6	,5	,4    )])
        ]
        for i in temp:
            lecture = self.get_lecture_contract(i[0])
            ...
            if publication is None:
                ...
                publication.timestamp = int(time.mktime(date.datetime.strptime(i[1], '%d.%m.%Y %H:%M:%S').timetuple()))
                appendTransaction(publication)
                self.transactions.append(publication)
            for j in i[2]:
                member = self.get_trello_member_by_trello_id(j[1])
                feedback = self.get_feedback(publication.id, member)
                if feedback is None:
                    feedback = CreateFeedbackContract(member.id, member.username, publication.id, j[2], j[3], j[4], j[5], j[6])
                    feedback.timestamp = int(time.mktime(date.datetime.strptime(j[0], '%d.%m.%Y %H:%M:%S').timetuple()))
